...
export const mockActivities: Record<string, Activity[]> = {
  ...
  "3": [
    ...
    },
    {
      ...
      type: "event",
      subject: "客戶來店賞車諮詢",
      description: "客戶對 Discovery Sport 有興趣，詢問配備與價格。",
      createdAt: new Date("2024-02-15"),
      startDateTime: new Date("2024-02-18T15:00:00"),
      endDateTime: new Date("2024-02-18T16:00:00"),
      // 此事件無關聯試駕同意書
    },
  ],
  "4": [
...
export const mockAccounts: Account[] = [
  ...
  },
  {
    ...
    lineStatus: "not-joined",
    phone: "0912345678",
    email: "shuhua.lin@example.com",
    convertedAt: new Date("2024-02-15"),
    avatarUrl: "/placeholder.svg?height=80&width=80&query=woman",
    birthday: new Date("1975-08-22"),
    gender: "female",
    language: "中文(繁體)",
    nationalId: "D456789012",
    mobilePhone: "0912345678",
    homePhone: "02-28123456",
    billingCity: "新北市",
    billingAddress: "板橋區文化路二段100號",
    shippingCity: "新北市",
    shippingAddress: "板橋區文化路二段100號",
    brandPreferences: ["Land Rover"],
    interestedModel: "Range Rover Evoque",
    leadSource: "walk-in",
    ...
    maintenanceStatus: "purchased",
    interests: ["旅遊", "時尚"],
    notes: "已購入 Range Rover Evoque，尚未完成 LINE 車主綁定。",
  },
]
